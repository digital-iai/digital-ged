...
class SteedForm extends React.Component {    
    render() {
        return (
            <Container>
                <Row>
                    <Col xl={12}>
                        <Row>
                            ...
                            <Col xs={{ size: 4, offset: 4 }}>                            
                                <Link className="btn btn-info text-white float-right" size="sm" to="/coursiers">
